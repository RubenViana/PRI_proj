...
query = {
    ...
    "sys3" : "http://localhost:8983/solr/wines_schemaless/select?defType=lucene&indent=true&q.op=OR&q=(review%3A%20Pinot%20AND%20review%3A%20Noir)%20(primary_grape%3A%20Pinot%20AND%20primary_grape%3A%20Noir)%20(name%3A%20Pinot%20AND%20name%3A%20Noir)&rows=20",
    "sys4" : "http://localhost:8983/solr/wines_schemaless/select?defType=lucene&indent=true&q.op=OR&q=(review%3A%20Pinot%20AND%20review%3A%20Noir)%20(primary_grape%3A%20Pinot%20AND%20primary_grape%3A%20Noir)%5E4%20(name%3A%20Pinot%20AND%20name%3A%20Noir)&rows=20"
}
