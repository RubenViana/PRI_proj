...
export const WineCard = (props) => {
  return (
    <Link to={"/wine/" + props.wine.wine_id} style={{ display: "contents" }}>
      <li key={props.wine.wine_id} className="w-[46rem] flex justify-between gap-x-6 p-5 rounded-lg hover:bg-green-50">
        <div className="flex min-w-0 gap-x-4">
          ...
          <div className="min-w-0">
            <p className="text-sm text-start font-semibold leading-6 text-gray-900">{props.wine.name}</p>
